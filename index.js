...
function changeBackground(weatherType) {
  if (weatherType === "Clouds") {
    document.body.style.backgroundImage =
      "url('./images/pexels-andre-moura-3774895.jpg')";
    ...
    document.body.style.backgroundImage =
      "url('./images/display-background-with-smoky-atmosphere_1048-14752.avif')";
    document.body.style.backgroundRepeat = "no-repeat";
    document.body.style.backgroundSize = "100% 100%";
    ...
    document.body.style.backgroundImage =
      "url('./images/winter-blue-sky-with-falling-snow-snowflakes-with-winter-landscape_227678-228.avif')";
    document.body.style.backgroundRepeat = "no-repeat";
    document.body.style.backgroundSize = "100% 100%";
  } else {
    document.body.style.backgroundImage =
      "url('./images/U7F7XGMON5FQRAZW4FHF577J4Q.avif')";
    document.body.style.backgroundRepeat = "no-repeat";
    document.body.style.backgroundSize = "100% 100%";
  }
}
